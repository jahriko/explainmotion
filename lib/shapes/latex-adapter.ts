...
import type { ShapePropertyAdapter, AnimatableShape, AnimatedShapePartial } from '@/lib/animation/adapters/types'

/** Adapter for the custom LaTeX shape */
export const latexAdapter: ShapePropertyAdapter = {
